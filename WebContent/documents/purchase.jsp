...
<%
	List<Product> productList = DbQuery.getRecentProducts();
if(null == productList || productList.size() == 0)
{
	out.print("<p style=\"font:italic small-caps bold 15px georgia;color:red\">No products on the site</p>");
}
else
{
	...
	for(int i = 0, k = 1; i < productList.size(); i++, k++)
	{
		...
		<tr>
		<td>
		<a href="/kamaz_web_commerce_platform/ProductDetailsServlet?product_id=<%= productList.get(i).getProduct_id() %>"><img height="200" src='images/<%= productList.get(i).getImg() %>'></img></a>
		</td>
		</tr>
		<tr>
		...
		<tr>
		<td align="center">
		<form action="/kamaz_web_commerce_platform/PurchaseProcess" method="post">
