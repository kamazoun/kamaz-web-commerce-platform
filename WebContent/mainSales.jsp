...
<%
if(null != sellerIdList && !sellerIdList.isEmpty())
{
	%>
	<table>
	<%
	for(int i = 0; i < sellerIdList.size(); i++)
	{
		...
		Integer user_id = Integer.parseInt(sellerIdList.get(i).getSeller_id());
		...
		<tr>
		<td>
		Quantity of items sold: <%= sellerIdList.get(i).getQuantity() %>
		</td>
		</tr>
		</table>
		</td>
