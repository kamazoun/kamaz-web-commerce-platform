...
<body>
	...
	<div
		...
		<table align="center" cellpadding="10" cellspacing="0" border="0"
			...
			<tr>
				<td><a
					href='changeUserProfilePhoto.jsp?user_id=<%=user_id%>&img=users/default.jpg'><img
						src='/kamaz_web_commerce_platform/images/users/default.jpg'
						alt="User photo" border="0" /></a></td>

				<td><a
					href='changeUserProfilePhoto.jsp?user_id=<%=user_id%>&img=users/homme_d_affaire.jpg'><img
						src='/kamaz_web_commerce_platform/images/users/homme_d_affaire.jpg'
						alt="User photo" border="0" /></a></td>
			</tr>
			<tr>
				<td><a
					href='changeUserProfilePhoto.jsp?user_id=<%=user_id%>&img=users/receptioniste.jpg'><img
						src='/kamaz_web_commerce_platform/images/users/receptioniste.jpg'
						alt="User photo" border="0" /></a></td>

				<td><a
					href='changeUserProfilePhoto.jsp?user_id=<%=user_id%>&img=users/kamaz.jpg'><img
						src='/kamaz_web_commerce_platform/images/users/kamaz.jpg'
						alt="User photo" border="0" /></a></td>
			</tr>
			<tr>
				<td><a
					href='changeUserProfilePhoto.jsp?user_id=<%=user_id%>&img=users/utilisatrice.jpg'><img
