...
<body>
	...
	<div style="position: relative; left: 500px; top: 100px;">
		...
		<table>
			<tr>
				<td align="center">Send a message to:</td>
			</tr>
			<tr>
				<td style="color: blue" align="center"><%=DbQuery.getUserFirstnameFromId(
					Integer.parseInt(receiver_id))%>
					<%=DbQuery.getUserGivennameFromId(
					Integer.parseInt(receiver_id))%></td>
			</tr>
			<tr>
				<td align="center"><img
			...
			<tr>
				<td>
					<form action="processSendMessage.jsp"
						method="post">
						<input type="text" name="details" value='@title:' size='61'
