...
<%
if(null != buyerIdList && !buyerIdList.isEmpty())
{
	%>
	<table>
	<%
	for(int i = 0; i < buyerIdList.size(); i++)
	{
		...
		Integer user_id = Integer.parseInt(buyerIdList.get(i).getBuyer_id());
		...
		<tr>
		<td>
		Quantity of items purchased: <%= buyerIdList.get(i).getQuantity() %>
		</td>
		</tr>
		</table>
		</td>
